...
# from app.llm import generate_response_with_context
...
#     3. Generate response using Gemini with the context
...
# def process_multi_turn_query(query: str, conversation_history: List[Dict], top_k: int = 5) -> Dict:
#     """
#     Process a query with conversation history for multi-turn conversations.
...
#         Dictionary containing response and metadata
#     """
#     # For now, we'll use the same logic as single query
#     # You can enhance this later to include conversation context
#     result = process_query(query, top_k)
#     result["conversation_aware"] = True
#     return result
